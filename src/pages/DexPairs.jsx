...
import { TrendingUp, TrendingDown, ArrowUpDown, Search, RefreshCw, Activity } from "lucide-react";
          ...
          try {
            ...
            if (pairInfo?.data) {
              ...
              pairs.push({
                ...
                quoteVolume: pairInfo.data.quoteVolume,
                change24h,
                high: pairInfo.data.high,
                low: pairInfo.data.low,
                txsCount: pairInfo.data.txsCount,
                weightedAveragePrice: pairInfo.data.weightedAveragePrice,
              });
            }
          } catch (error) {
            continue;
