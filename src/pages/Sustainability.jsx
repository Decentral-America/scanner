...
import { Leaf, Globe, Zap, TrendingUp, Award } from "lucide-react";
...
export default function Sustainability() {
  ...
  useEffect(() => {
    const analyzeGreenHosting = async () => {
      ...
      for (const peer of connected.peers) {
        ...
        try {
          ...
          // Check green hosting
          const greenResponse = await fetch(`https://api.thegreenwebfoundation.org/api/v3/greencheck/${ip}`);
